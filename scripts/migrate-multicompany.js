 ...
 try{
  ...
  await client.query(`
   ...
   CREATE TABLE IF NOT EXISTS trip_documents (
    ...
    document_type VARCHAR(30) NOT NULL CHECK(document_type IN ('CTE','Abastecimento','Outros gastos')),
   ...
   CREATE INDEX IF NOT EXISTS idx_trip_documents_trip ON trip_documents(company_id,trip_id,created_at DESC);
   ALTER TABLE trip_documents ADD COLUMN IF NOT EXISTS amount NUMERIC(12,2);
   ALTER TABLE trip_documents ADD COLUMN IF NOT EXISTS km NUMERIC(12,1);
   ...
   CREATE INDEX IF NOT EXISTS idx_purchase_invoices_company ON purchase_invoices(company_id,created_at DESC);
   CREATE INDEX IF NOT EXISTS idx_purchase_allocations_invoice ON purchase_invoice_allocations(invoice_id);
   CREATE INDEX IF NOT EXISTS idx_purchase_allocations_customer ON purchase_invoice_allocations(customer_id);
  `);
